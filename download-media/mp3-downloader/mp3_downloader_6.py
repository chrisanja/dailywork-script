# The folder picker show the current code file located 
...
def choose_folder():
    """Open folder picker window starting at script location."""
    root = tk.Tk()
    root.withdraw()
    script_dir = os.path.dirname(os.path.abspath(__file__))  # Script's folder
    folder_selected = filedialog.askdirectory(
        title="Select Save Location",
        initialdir=script_dir  # Start here
    )
